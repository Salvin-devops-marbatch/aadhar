...
curl -X POST -H "Content-type: application/json"  -u SalvinInfosys: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  -d "{\"title\": \"SSHKEY\"}" "https://api.github.com/user/keys?access_token=$token"
if [ $? -eq 0 ]
then 
